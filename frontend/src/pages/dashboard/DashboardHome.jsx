    ...
    <>
      ...
      <div className="card mt-10 overflow-hidden bg-ink-950/12">
        <div className="grid gap-px sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat) => (
            <div key={stat.label} className="bg-cream-50 px-6 py-5">
      ...
      <section className="mt-12">
        ...
        {status === 'error' ? (
          <div className="mt-4 flex items-start gap-2.5 rounded-xl border border-ink-950/12 bg-cream-50 px-4 py-3" role="alert">
        ...
        {status === 'ready' && documents.length === 0 ? (
          <div className="card mt-4 px-6 py-12 text-center">
            ...
            <p className="mx-auto mt-2 max-w-sm text-sm leading-relaxed text-ink-600">
              Describe what you need — a board update, a project brief, a training session — and Levitron will draft the
              structure for you.
            </p>
