  ...
  return (
    <section id="top" className="relative overflow-hidden pt-36 pb-20 sm:pt-44 sm:pb-28">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="animate-drift absolute -top-40 left-1/2 h-[42rem] w-[42rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(0,0,0,0.09),transparent_62%)] blur-2xl" />
        <div className="animate-ember absolute -top-24 right-[8%] h-72 w-72 rounded-full bg-[radial-gradient(circle,rgba(0,0,0,0.05),transparent_65%)] blur-2xl" />
      </div>
      ...
      <div className="shell relative">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="reveal mt-7 text-4xl leading-[1.05] text-ink-950 sm:text-5xl md:text-6xl lg:text-7xl" style={{ '--reveal-delay': '60ms' }}>
            Turn a prompt into a deck
            <br className="hidden sm:block" /> worth <span className="text-gradient">presenting</span>.
          </h1>

          <p className="reveal mx-auto mt-7 max-w-2xl text-base leading-relaxed text-ink-600 sm:text-lg" style={{ '--reveal-delay': '140ms' }}>
          ...
          <p className="reveal mt-6 text-sm text-ink-500" style={{ '--reveal-delay': '280ms' }}>
            No credit card. No account. One command:{' '}
            <code className="font-mono text-ink-950">docker run levitron</code>
          </p>
        </div>
      </div>
    </section>
